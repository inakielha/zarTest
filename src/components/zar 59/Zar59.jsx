        ...
        <div className={s.section}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
                ...
                <div className={s.galeria}>
                    ...
                    <div className={s.imgGaleria}><img id="0" onClick={(e) => bigPicture(e)} src={pathImages + lancha2} alt="" /></div>
                    <div className={s.imgGaleria}><img id="1" onClick={(e) => bigPicture(e)} src={pathImages + lancha3} alt="" /></div>
                    <div className={s.imgGaleria}><img id="2" onClick={(e) => bigPicture(e)} src={pathImages + lancha} alt="" /></div>
                </div>
